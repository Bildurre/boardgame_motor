...
php artisan motor:rewrite-urls http://localhost:8010 /   # tras importar una BD de otro entorno: deja relativas las URL absolutas del contenido (--dry-run para solo contar)
